...
public Calculator() {
	expr = new Declaration[2];
	nset = new ArrayList();
	for (int i = 0; i < expr.length; i++)
		expr[i] = new Declaration();
	numMode = DEC;
	memValue = "0";
	initFields();
}
	...
	switch (key) {
		...
		case NEG: case POW: case MUL: case DIV: case MOD: case ADD: case SUB:
			if (prmScreenText != "0" || isDigit(lastKey))
				push(prmScreenText);
			if (key.equals(BR1)) push(Declaration.BRO);
			else if (key.equals(BR2)) push(Declaration.BRC);
			else if (key.equals(SRT)) push(Declaration.SRT);
			else if (key.equals(CRT)) push(Declaration.CRT);
			else if (key.equals(REC)) push(Declaration.REC);
			else if (key.equals(SQR)) push(Declaration.SQR);
			else if (key.equals(CUB)) push(Declaration.CUB);
			else if (key.equals(FCT)) push(Declaration.FCT);
			else if (key.equals(SIN)) push(Declaration.SIN);
			else if (key.equals(COS)) push(Declaration.COS);
			else if (key.equals(TAN)) push(Declaration.TAN);
			else if (key.equals(LOG)) push(Declaration.LOG);
			else if (key.equals(NLG)) push(Declaration.NLG);
			else if (key.equals(INT)) push(Declaration.INT);
			else if (key.equals(NEG)) push(Declaration.NEG);
			else if (key.equals(POW)) push(Declaration.POW);
			else if (key.equals(MUL)) push(Declaration.MUL);
			else if (key.equals(DIV)) push(Declaration.DIV);
			else if (key.equals(MOD)) push(Declaration.MOD);
			else if (key.equals(ADD)) push(Declaration.ADD);
			else if (key.equals(SUB)) push(Declaration.SUB);
